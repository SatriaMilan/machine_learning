...
Original file is located at
    https://colab.research.google.com/drive/1-tWpplriPKB1m0gdI7_0hkyjIcyCSBpK
...
temp = '/content/drive/MyDrive/Tempp'
...
train_generator = train_datagen.flow_from_directory(directory=train_dir, target_size=(224,224), shuffle=True, class_mode='categorical')
...
history = model.fit(train_generator, steps_per_epoch=training_steps_per_epoch,
                    ...
                    epochs=EPOCHS, verbose=1, callbacks=[callnew])
